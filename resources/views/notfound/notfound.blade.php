    ...
    <style>
       ...
       /* 2. CONTENT */
        ...
        .e-nav__link {
            ...
            margin: 0 15px;
            border-radius: 200px;
            /* background: rgb(3,67,68);
background: linear-gradient(0deg, rgba(3,67,68,1) 18%, rgba(253,187,45,1) 100%); */
            border: 1px solid #5656b8;
            color: #4d4d4e;
            text-decoration: none;
            font-family: 'Montserrat', sans-serif;
            text-transform: uppercase;
        ...
        .e-nav__link:hover {
            background: rgb(37,39,140);
background: radial-gradient(circle, rgba(37,39,140,1) 0%, rgba(0,0,0,1) 100%);
            color: #fff;
...
@endsection
@section('content')
    <a href="{{ route('etudiants.liste') }}" target="_blank">
        ...
        <section class="error">
            ...
            <div class="error__content">
                <div class="error__message message">
                    <h1 class="message__title">La page introuvable</h1>
                    <p class="message__text">Nous sommes désolés, la page que vous recherchez ne se trouve pas ici.</p>
                </div>
                <div class="error__nav e-nav">
                    <a href="{{ route('etudiants.liste') }}" target="_blanck" class="e-nav__link"></a>
                </div>
            </div>
            <!-- END Content -->
